...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DelivereeApi.InlineResponse200 = factory(root.DelivereeApi.ApiClient, root.DelivereeApi.Location);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('eta_from_driver_to_pickup'))
        obj.etaFromDriverToPickup = ApiClient.convertToType(data['eta_from_driver_to_pickup'], 'Number');
      if (data.hasOwnProperty('distance_from_driver_to_pickup'))
        obj.distanceFromDriverToPickup = ApiClient.convertToType(data['distance_from_driver_to_pickup'], 'Number');
