...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './PositionTracking'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PositionTracking'));
  } else {
    // Browser globals (root is window)
    if (!root.DelivereeApi) {
      root.DelivereeApi = {};
    }
    root.DelivereeApi.Location = factory(root.DelivereeApi.ApiClient, root.DelivereeApi.PositionTracking);
  }
}(this, function(ApiClient, PositionTracking) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('recipient_name'))
        obj.recipientName = ApiClient.convertToType(data['recipient_name'], 'String');
      if (data.hasOwnProperty('recipient_phone'))
        obj.recipientPhone = ApiClient.convertToType(data['recipient_phone'], 'String');
      ...
      if (data.hasOwnProperty('cod_invoice_fees'))
        obj.codInvoiceFees = ApiClient.convertToType(data['cod_invoice_fees'], 'Number');
      ...
      if (data.hasOwnProperty('position_trackings'))
        obj.positionTrackings = ApiClient.convertToType(data['position_trackings'], [PositionTracking]);
    }
    return obj;
  }
