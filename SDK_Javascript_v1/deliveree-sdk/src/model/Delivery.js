...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DelivereeApi.Delivery = factory(root.DelivereeApi.ApiClient, root.DelivereeApi.Location);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('vehicle_type_id'))
        obj.vehicleTypeId = ApiClient.convertToType(data['vehicle_type_id'], 'Number');
      ...
      if (data.hasOwnProperty('job_order_number'))
        obj.jobOrderNumber = ApiClient.convertToType(data['job_order_number'], 'String');
      if (data.hasOwnProperty('allow_parking_fees'))
        obj.allowParkingFees = ApiClient.convertToType(data['allow_parking_fees'], 'Boolean');
      if (data.hasOwnProperty('allow_tolls_fees'))
        obj.allowTollsFees = ApiClient.convertToType(data['allow_tolls_fees'], 'Boolean');
      if (data.hasOwnProperty('allow_waiting_time_fees'))
        obj.allowWaitingTimeFees = ApiClient.convertToType(data['allow_waiting_time_fees'], 'Boolean');
      if (data.hasOwnProperty('fleet_partner_id'))
        obj.fleetPartnerId = ApiClient.convertToType(data['fleet_partner_id'], 'Number');
      if (data.hasOwnProperty('container_size'))
        obj.containerSize = ApiClient.convertToType(data['container_size'], 'String');
