    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (array_key_exists('Content-Disposition', $httpHeaders) &&
                ...
                $filename = DelivereeConfig::getDefaultConfiguration()->getTempFolderPath() . DIRECTORY_SEPARATOR . self::sanitizeFilename($match[1]);
            } else {
                $filename = tempnam(DelivereeConfig::getDefaultConfiguration()->getTempFolderPath(), '');
            }
