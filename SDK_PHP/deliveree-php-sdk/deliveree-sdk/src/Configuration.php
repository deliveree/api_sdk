...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.sandbox.deliveree.com/public_api/v1';

    /**
     * User agent of the HTTP request, set to "PHP-Deliveree" by default
     *
     * @var string
     */
    protected $userAgent = 'Deliveree/1.0.0/php';
