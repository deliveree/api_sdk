...
namespace IO.Deliveree.Client
{
        ...
        public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Deliveree/1.0.0/csharp";
            BasePath = "https://api.sandbox.deliveree.com/public_api/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://api.sandbox.deliveree.com/public_api/v1") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "Deliveree/1.0.0/csharp"
        ...
        {
            String report = "C# SDK (IO.Deliveree) Debug Report:\n";
